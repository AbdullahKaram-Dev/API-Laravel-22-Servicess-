...
<div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="black" data-image="{{asset('dashboard/img/sidebar-2.jpg')}}">
        <!--
        ...
        <div class="sidebar-wrapper">
            <ul class="nav">
                <li class="nav-item active  ">
                    <a class="nav-link" href="{{route('Governorate.index')}}">
                        <i class="material-icons">Governorates</i>
                        <p>Governorate</p>
                    </a>
...
<script src="{{asset('dashboard/js/material-dashboard.js?v=2.1.0')}}"></script>
